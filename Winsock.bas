...
Private Sub OnReadTCP(lHandle As Long, sBuffer As String)
  Window.OnReadTCP lHandle, sBuffer
End Sub

Private Sub OnReadUDP(lHandle As Long, sBuffer As String, sAddress As String)
  Window.OnReadUDP lHandle, sBuffer, sAddress
End Sub

Private Sub OnIncoming(lHandle As Long, sNewSocket As Long)
  Window.OnIncoming lHandle, sNewSocket
End Sub

Private Sub OnConnected(lHandle As Long)
  Window.OnConnected lHandle
End Sub

Private Sub OnConnectError(lHandle As Long, lError As Long)
  Window.OnConnectError lHandle, lError
End Sub

Private Sub OnClose(lHandle As Long)
